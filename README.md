...
- [Environment Setup](#environment-setup)
  - [Option 1: uv (recommended)](#option-1-using-uv-recommended)
  - [Option 2: conda](#option-2-using-conda)
  - [Option 3: pip](#option-3-using-pip)
- [Running the Pipeline](#running-the-pipeline)
  ...
  - [Step 3: Generate PLM embeddings](#step-3-generate-protein-language-model-embeddings)
...
This project uses two publicly available, gated datasets from [Ginkgo Datapoints](https://www.ginkgobioworks.com/):

| Dataset | Antibodies | Access |
|---------|------------|--------|
| GDPa1 | 246 IgGs (training set) | Available on [Hugging Face](https://huggingface.co/) — search "Ginkgo Datapoints GDPa1" |
| GDPa3 | 80 IgGs (holdout set) | Available on the [Ginkgo Datapoints website](https://www.ginkgobioworks.com/) |
...
- EDA notebooks (`notebooks/`) — written by Eduardo Pacheco and Allen Chezick.
